#include "template_mock_calculator.h" // Includes the Concept and CalculatorManager
#include <gmock/gmock.h>
#include <gtest/gtest.h>
#include <templatelib/calculator.h> // Includes the Concept and CalculatorManager
...
TEST(TemplateCalculatorTest, RealCalc_SumIsOdd_ReturnsSum) {
	// Arrange
...
TEST(TemplateCalculatorTest, RealCalc_SumIsEven_ReturnsProcessedValue) {
	// Arrange
	templatelib::Calculator real_calc;
	// T_Calculator = Calculator. Concept check passes.
	templatelib::CalculatorManager<templatelib::Calculator> real_calc_manager(real_calc);
...
// Renamed Test Fixture to TemplateCalculatorTest
// Test the Consumer with the MOCK Dependency (Isolation)
TEST(TemplateCalculatorTest, Mock_SumIsEven_ReturnsMockedProcessedValue) {
	// Arrange
	MockTemplateCalculator mock_calc;
	// T_Calculator = MockTemplateCalculator. Concept check passes.
	templatelib::CalculatorManager<MockTemplateCalculator> mock_calc_manager(mock_calc);
...
TEST(TemplateCalculatorTest, Mock_DoubleMultiply_ReturnsMockedMultipliedValue) {
	// Arrange
	MockTemplateCalculator mock_calc;
	templatelib::CalculatorManager<MockTemplateCalculator> mock_calc_manager(mock_calc);
